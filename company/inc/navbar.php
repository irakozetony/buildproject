<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOffices"
                    aria-expanded="true" aria-controls="collapseOffices">
            ...
            <li class="nav-item">
                ...
                <div id="collapseCustomers" class="collapse" aria-labelledby="headingCustomers"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="new_customers.php">New</a>
                        <a class="collapse-item" href="approved_customers.php">Approved</a>
                        <a class="collapse-item" href="rejected_customers.php">Rejected</a>
                        <a href="customers.php" class="collapse-item">All</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="card border-left-success" style=" border-radius: 0px; padding: 25px;">
                                        <div class="small text-gray-500"><?php echo $row['office_reserved']; ?></div>
                                        <span class="font-weight-bold"><?php echo $row['reservation_date']; ?></span>
                                    </div>
                                </a>
                                <?php
                        }
                        ...
                        echo "<div class=\"card border-left-danger\" id=\"form-message\" style=\" border-radius: 0px; padding: 25px;\">
                        <div class=\"card-body\">No New Bookings</div>
                      </div>";
                    }
                    ?>
                                <a class="dropdown-item text-center small text-gray-500" href="new_customers.php">All New Requests</a>
                            </div>
                        </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="logout_button" class="btn btn-primary">Logout</button>
                    </form>
                </div>
            </div>
        </div>
